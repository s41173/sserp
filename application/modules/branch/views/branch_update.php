 ...
 action="<?php echo $form_action_update; ?>" enctype="multipart/form-data">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
            ...
            <span class="fa fa-envelope form-control-feedback right" aria-hidden="true"></span> 
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                    <input type="tel" name="tphone" class="form-control has-feedback-left" id="tphone_update" placeholder="Phone">
                    <span class="fa fa-phone form-control-feedback left" aria-hidden="true"></span> 
                  </div>
                  
                  <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                    <input type="tel" name="tmobile" class="form-control" id="tmobile_update" placeholder="Mobile">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                    <input type="text" name="tzip" class="form-control" id="tzip_update" placeholder="Zip Code">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                      <input type="text" name="tcode" id="tcode_update" class="form-control" placeholder="Branch Code">
                    </div>
                  </div>
...
<textarea name="taddress" id="taddress_update" class="form-control" rows="3" placeholder="Address"><?php echo set_value('taddress', isset($default['address']) ? $default['address'] : ''); ?></textarea>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
<input type="text" name="tsalesacc" id="titem_update" class="form-control" required readonly style="max-width:120px; float:left;"> 
<?php echo anchor_popup(site_url("account/get_list/titem_update/"), '[ ... ]', $atts1); ?> 
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
<input type="text" name="tstockacc" id="titem2_update" class="form-control" required readonly style="max-width:120px; float:left;"> 
