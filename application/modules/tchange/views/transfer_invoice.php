...
<h2 style="font-size:18px; font-weight:normal; text-align:center; text-decoration:underline;"> TANK STATUS CHANGE </h2> 
	...
	<div style="width:350px; border:0px solid #000; float:left;">
		<table style="font-size:13px; font-family:Tahoma, Geneva, sans-serif;">
            ...
            <tr> <td> Content </td> <td>:</td> <td> <?php echo $from; ?> - <?php echo $to; ?> </td> </tr>
