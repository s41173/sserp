    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
                  { text: 'No', dataField: 'No', width: 50 },
   				  { text: 'Transcode', dataField: 'Transcode', width : 130 },
				  { text: 'Date', dataField: 'Date', width : 130 },
				  { text: 'Tank', dataField: 'Tank', width : 120 },
                  { text: 'Notes', dataField: 'Notes' },
				  { text: 'From-To', dataField: 'From-To',width : 230 },
				  { text: 'Log', datafield: 'Log', width: 250 }
                ]
            });
			...
			$("#bexport").click(function() {
				...
				var type = $("#crtype").val();	
				if (type == 0){ $("#jqxgrid").jqxGrid('exportdata', 'html', 'TChange-Summary'); }
				else if (type == 1){ $("#jqxgrid").jqxGrid('exportdata', 'xls', 'TChange-Summary'); }
				else if (type == 2){ $("#jqxgrid").jqxGrid('exportdata', 'pdf', 'TChange-Summary'); }
				else if (type == 3){ $("#jqxgrid").jqxGrid('exportdata', 'csv', 'TChange-Summary'); }
			});
...
<tr> <td> Log </td> <td> : </td> <td> <?php echo $log; ?> </td> </tr>
	...
	<center>
	   <div style="border:0px solid green; width:230px;">	
	       <h4> <?php echo isset($company) ? $company : ''; ?> <br> Tank Status Change Report </h4>
	   </div>
	</center>
	...
	<div style="width:100%; border:0px solid brown; margin-top:20px; border-bottom:1px dotted #000000; ">
		...
		<table id="table" border="0" width="100%">
           ...
           <thead>
		   <tr>
<th> No </th> <th> Transcode </th> <th> Date </th> <th> Tank </th> <th> Notes </th> <th> From-To </th> <th> Log </th>
		   </tr>
           </thead>
		  ...
		  <?php 
		      ...
		      function tank($val=null)
			  {
				$account = new Tank_lib();  
  			    return $account->get_details($val,'sku');
			  }
			  ...
			  if ($reports)
			  {
				...
				{	
				   ...
				   <tr> 
					   ...
					   <td class=\"strongs\">".$res->no."</td> 
					   <td class=\"strongs\">".tglin($res->dates)."</td> 
					   <td class=\"strongs\">".tank($res->tank_id)."</td> 
                       <td class=\"strongs\">".$res->notes."</td> 
					   <td class=\"strongs\">".$res->from.' - '.$res->to."</td> 
					   <td class=\"strongs\" align=\"right\">".$res->log."</td> 
				   </tr>";
				   $i++;
				}
			 }  
...
<a style="float:left; margin:10px;" title="Back" href="<?php echo site_url('tchange'); ?>"> 
