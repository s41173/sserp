...
<script src="<?php echo base_url(); ?>js/moduljs/attribute.js"></script>
<script src="<?php echo base_url(); ?>js-old/register.js"></script>

<script type="text/javascript">

	var sites_add  = "<?php echo site_url('attribute/add_process/');?>";
	var sites_edit = "<?php echo site_url('attribute/update_process/');?>";
	var sites_del  = "<?php echo site_url('attribute/delete/');?>";
	var sites_get  = "<?php echo site_url('attribute/update/');?>";
  ...
  <div class="btn-group">
   ...
   <a class="btn btn-primary" href="<?php echo site_url('color'); ?>"> Color </a>
   <a class="btn btn-primary" href="<?php echo site_url('size'); ?>"> Size </a>
      ...
      <div class="modal fade" id="myModal" role="dialog">
         <?php $this->load->view('attribute_form'); ?>      
      </div>
      <!-- Modal - Add Form -->
      
      <!-- Modal Edit Form -->
      <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	     <?php $this->load->view('attribute_update'); ?> 
      </div>
      <!-- Modal Edit Form -->
