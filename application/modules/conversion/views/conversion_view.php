...
<script src="<?php echo base_url(); ?>js/moduljs/conversion.js"></script>
<script src="<?php echo base_url(); ?>js-old/register.js"></script>

<script type="text/javascript">

	var sites_add  = "<?php echo site_url('conversion/add_process/');?>";
	var sites_edit = "<?php echo site_url('conversion/update_process/');?>";
	var sites_del  = "<?php echo site_url('conversion/delete/');?>";
	var sites_get  = "<?php echo site_url('conversion/update/');?>";
    var sites_primary  = "<?php echo site_url('conversion/primary/');?>";
...
<!-- <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal"> <i class="fa fa-plus"></i>&nbsp;Add New </button>-->
      ...
      <div class="modal fade" id="myModal" role="dialog">
         <?php //$this->load->view('language_form'); ?>      
      </div>
      <!-- Modal - Add Form -->
      
      <!-- Modal Edit Form -->
      <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	     <?php $this->load->view('conversion_update'); ?> 
      </div>
      <!-- Modal Edit Form -->
