...
<script src="<?php echo base_url(); ?>js/moduljs/division.js"></script>
<script src="<?php echo base_url(); ?>js-old/register.js"></script>

<script type="text/javascript">

	var sites_add  = "<?php echo site_url('division/add_process/');?>";
	var sites_edit = "<?php echo site_url('division/update_process/');?>";
	var sites_del  = "<?php echo site_url('division/delete/');?>";
	var sites_get  = "<?php echo site_url('division/update/');?>";
...
?>
 ...
 <?php echo anchor_popup(site_url("division/report"), 'Report', $atts1); ?>
      ...
      <div class="modal fade" id="myModal" role="dialog">
         <?php $this->load->view('division_form'); ?>      
      </div>
      <!-- Modal - Add Form -->
      
      <!-- Modal Edit Form -->
      <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	     <?php $this->load->view('division_update'); ?> 
      </div>
      <!-- Modal Edit Form -->
