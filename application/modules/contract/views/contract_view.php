...
<script type="text/javascript">
	...
	var sites_add  = "<?php echo site_url('contract/add_process/');?>";
	var sites_edit = "<?php echo site_url('contract/update_process/');?>";
	var sites_del  = "<?php echo site_url('contract/delete/');?>";
    var sites_update = "<?php echo site_url('contract/update_all/');?>";
	var sites_get  = "<?php echo site_url('contract/update/');?>";
    var sites_details  = "<?php echo site_url('contract/details/');?>";
    var sites_primary  = "<?php echo site_url('contract/confirmation/');?>";
	var source = "<?php echo $source;?>";
    var sites  = "<?php echo site_url('contract/');?>";
         ...
         echo form_dropdown('ccust', $customer, isset($default['']) ? $default[''] : '', $js); ?>
               ...
               <div class="form-group">
                <label> Type </label> <br>  
                <select name="ctype" id="ctype_search" class="select2_single form-control" style="min-width:140px;">
