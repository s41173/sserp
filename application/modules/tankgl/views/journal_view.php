...
<script type="text/javascript">
    ...
    var sites_ajax  = "<?php echo site_url('tankgl/');?>";
...
<?php  $js = "class='select2_single form-control' id='ccust_search' tabindex='-1' style='width:170px; float:left; margin-right:10px;' ";
	     echo form_dropdown('ccust', $customer, isset($default['customer']) ? $default['customer'] : '', $js); ?>
       </div>         
...
-->
   ...
   <div class="btn-group">
   <a class="btn btn-primary" href="<?php echo site_url('tankgl/add'); ?>"> <i class="fa fa-plus"></i>&nbsp;Add New  </a>
   ...
   <!-- links -->
      ...
      <div class="modal fade" id="myModal3" role="dialog">
         <?php $this->load->view('journal_report_panel'); ?>    
      </div>
      <!-- Modal - Report Form -->
