        ...
        $(document).ready(function () {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
				  ...
				  { text: 'Customer', dataField: 'Customer', width : 100 },
				  { text: 'Doc-No', dataField: 'Doc-No', width : 180 },
                  { text: 'Doc-Type', dataField: 'Doc-Type', width : 150 },
				  { text: 'Date', dataField: 'Date', width : 130 },
				  { text: 'Notes', dataField: 'Notes' },
{ text: 'Balance', datafield: 'Balance', width: 180, cellsalign: 'right', cellsformat: 'F2', aggregates: ['sum'] },
			...
			$("#bexport").click(function() {
				...
				var type = $("#crtype").val();	
				if (type == 0){ $("#jqxgrid").jqxGrid('exportdata', 'html', 'StorageJournal-Summary'); }
				else if (type == 1){ $("#jqxgrid").jqxGrid('exportdata', 'xls', 'StorageJournal-Summary'); }
				else if (type == 2){ $("#jqxgrid").jqxGrid('exportdata', 'pdf', 'StorageJournal-Summary'); }
				else if (type == 3){ $("#jqxgrid").jqxGrid('exportdata', 'csv', 'StorageJournal-Summary'); }
			});
...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<center>
	   <div style="border:0px solid green; width:230px;">	
	       <h4> <?php echo isset($company) ? $company : ''; ?> <br> Storage Journal Transaction - Report </h4>
	   </div>
	</center>
...
<thead>
<tr>
<th> No </th> <th> Customer </th> <th> Doc-No </th> <th> Doc-Type </th> <th> Date </th> <th> Notes </th> 
<th> Balance </th> <th> Posted </th>
</tr>
</thead>
...
<?php 
  ...
  {
    function cust($cust){
        $val = new Customer_lib();
        return $val->get_name($cust);
    }  
    ...
    {	
       ...
       <tr> 
           ...
           <td class=\"strongs\">".strtoupper(cust($ap->cust_id))."</td>
		   <td class=\"strongs\">".$ap->docno."</td>
           <td class=\"strongs\">".$ap->doctype."</td>
		   <td class=\"strongs\">".tglin($ap->dates)."</td> 
           <td class=\"strongs\">".$ap->notes."</td>
           <td class=\"strongs\" align=\"right\">".$ap->balance."</td> 
...
<a style="float:left; margin:10px;" title="Back" href="<?php echo site_url('tankgl'); ?>"> 
