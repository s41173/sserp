...
<script src="<?php echo base_url(); ?>js/moduljs/tankgl.js"></script>
<script src="<?php echo base_url(); ?>js-old/register.js"></script>

<script type="text/javascript">

	var sites_add  = "<?php echo site_url('tankgl/add_process/');?>";
	var sites_edit = "<?php echo site_url('tankgl/update_process/');?>";
	var sites_del  = "<?php echo site_url('tankgl/delete/');?>";
	var sites_get  = "<?php echo site_url('tankgl/update/');?>";
    var sites  = "<?php echo site_url('tankgl/');?>";
...
<!-- div untuk customer place  -->
       <div id="custtitlebox" class="col-md-12 col-sm-12 col-xs-12">
         ...
         <select name="ctype" id="ctype" class="form-control" style="width:90px; float:left; margin-right:10px;">
...
<option value="AJE"<?php echo set_select('ctype', 'AJE', isset($default['type']) && $default['type'] == 'AJE' ? TRUE : FALSE); ?>> AJE </option>
     ...
     <input type="text" name="tno" id="tno" class="form-control" style="width:170px;" value="<?php echo $counter; ?>">           
               </div>
...
<!-- div tgl transaksi -->
    <div class="col-md-4 col-sm-12 col-xs-12">
       ...
       <div class="col-md-12 col-sm-12 col-xs-12">
          <label class="control-label labelx"> Description / Remarks </label>
...
<div class="row">
 ...
 <!-- searching form -->
   ...
   <form id="ajaxtransform" class="form-inline" method="post" action="<?php echo $form_action_item; ?>">
      <div class="form-group">
        <label class="control-label labelx"> Tank </label> <br>
...
<!--
      <div class="form-group">
        <label class="control-label labelx"> Dirt </label> <br>
        <input type="number" name="tdirt" id="tdirt" class="form-control" style="width:100px;" maxlength="10" required value="0"> &nbsp;
      </div>
       
      <div class="form-group">
        <label class="control-label labelx"> FFA </label> <br>
        <input type="number" name="tffa" id="tffa" class="form-control" style="width:100px;" maxlength="10" required value="0"> &nbsp;
      </div>
       
      <div class="form-group">
        <label class="control-label labelx"> Moisture </label> <br>
        <input type="number" name="tmoisture" id="tmoisture" class="form-control" style="width:100px;" maxlength="10" required value="0"> &nbsp;
      </div>
-->
      ...
      <table class="table table-striped jambo_table bulk_action">
        <thead>
          <tr class="headings">
            ...
            <th class="column-title"> Storage Tank </th>
        ...
        <?php
            ...
            {
                $acc = new Tank_lib();
                return $acc->get_details($val,'sku');
            }
