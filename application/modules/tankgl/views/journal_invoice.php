...
<title> General Journal - <?php echo $codetrans.'-'.$code; ?></title>
<style media="all">
...
<div style="width:750px; font-family:Arial, Helvetica, sans-serif; font-size:12px;"> 
	...
	<h2 style="font-size:18px; font-weight:normal; text-align:center; text-decoration:underline;"> STORAGE JOURNAL VOUCHER </h2> 
    <div style="clear:both; "></div> 
	
	<div style="width:350px; border:0px solid #000; float:left;">
		<table style="font-size:11px;">
 		    <tr> <td> Doctype </td> <td>:</td> <td> <?php echo $code; ?> </td> </tr>
...
<tr> <th> No </th>  <th> Tank Code </th> <th> Debit </th> <th> Credit </th> 
</tr>
			...
			if ($items)
			{
				...
				foreach ($items as $res)
				{
					echo "
					 ...
					 <tr> 
						<td> ".$i." </td>
						<td class=\"left\"> ".$tank->get_details($res->tank_id,'sku')." </td>
						<td class=\"right\"> ".number_format($res->debit,2)." </td> 
						<td class=\"right\"> ".number_format($res->credit,2)." </td>
					 </tr>
		...
		<tr> <td colspan="1"></td> <td class="right"> <b> Total : </b> </td>
