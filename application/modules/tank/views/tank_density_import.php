...
<div class="modal-header">
  ...
  <h4 class="modal-title"> Import CSV - Density </h4>
</div>
...
<form id="xupload_form_non" data-parsley-validate class="form-horizontal form-label-left" method="POST"
...
<!--  <a class="btn btn-default" href="<?php //echo site_url('product/download'); ?>"> Download CSV - Format </a>-->
          </div>
      </div>
  </form> 
