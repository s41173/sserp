...
<div style="width:750px; font-family:Arial, Helvetica, sans-serif; font-size:12px;"> 
	...
	<h2 style="font-size:18px; font-weight:normal; text-align:center; text-decoration:underline;"> PAYMENT VOUCHER </h2> <div style="clear:both; "></div> 
	
	<div style="width:350px; border:0px solid #000; float:left;">
		<table style="font-size:11px;">
 		    <tr> <td> Paid To </td> <td>:</td> <td> <p style="font-size:14px; font-weight:bold;"> <?php echo $vendor; ?> </p> </td> </tr>
	...
	<div style="width:200px; border:0px solid red; float:right;">
		<table style="font-size:11px;">
			<tr> <td> Transcode </td> <td>:</td> <td> <p style="font-size:14px; font-weight:bold;"> CD-0<?php echo $pono; ?> </p> </td> </tr>
			...
			if ($items)
			{
				...
				foreach ($items as $res)
				{
					echo "
					 ...
					 <tr> 
						<td> ".$i." </td>
						<td class=\"left\"> ".hide($res->code."-00".$res->no,$type)." - ".$res->notes." &nbsp; - &nbsp; ".tgleng($res->dates)." </td> 
