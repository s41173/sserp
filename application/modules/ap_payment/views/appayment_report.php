...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
    ...
    <div id='jqxWidget'>
		...
		<table id="table" border="0" width="100%">
		   <thead>
           <tr>
 	       <th> No </th> <th> Date </th> <th> Code </th> <th> Vendor </th> <th> Cur </th> <th> Acc </th> <th> Amount </th> <th> Discount </th> <th> Late-Charge </th> <th> Balance </th> <th> Over </th> <th> Balance-Over </th> <th> Credit-Status </th> <th> Log </th> 
		   </tr>
           </thead>
		  ...
		  <?php 
			  ...
			  function purchase_status($val) { if ($val==1){ $val = 'settled'; } else{ $val = 'debt'; } return $val; }
...
<a style="float:left; margin:10px;" title="Back" href="<?php echo site_url('ap_payment'); ?>"> 
