...
<script type="text/javascript">
    ...
    var sites  = "<?php echo site_url('ap_payment/');?>";
   ...
   <form id="ajaxtransform" class="form-inline" method="post" action="<?php echo $form_action_item; ?>">
      <div class="form-group">
        <label class="control-label labelx"> Transaction </label> <br>
           <input id="titem" class="form-control col-md-2 col-xs-12" type="text" readonly name="titem" required style="width:100px;" placeholder="PO">
          <div class="btn-group">    
          <?php echo anchor_popup(site_url("purchase/get_list/".$default['currency'].'/'.$venid), '[ ... ]', $atts1); ?>
