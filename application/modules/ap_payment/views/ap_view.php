...
<script src="<?php echo base_url(); ?>js/moduljs/ap_payment.js"></script>
...
<script type="text/javascript">
	...
	var sites_add  = "<?php echo site_url('ap_payment/add_process/');?>";
	var sites_edit = "<?php echo site_url('ap_payment/update_process/');?>";
	var sites_del  = "<?php echo site_url('ap_payment/delete/');?>";
	var sites_get  = "<?php echo site_url('ap_payment/update/');?>";
    var sites_ajax  = "<?php echo site_url('ap_payment/');?>";
...
-->
   ...
   <div class="btn-group">
   <a class="btn btn-primary" href="<?php echo site_url('ap_payment/add'); ?>"> <i class="fa fa-plus"></i>&nbsp;Add New  </a>
   <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal2"> Report  </button>
   <button type="button" class="btn btn-success" data-toggle="modal" data-target="#myModal3"> Payable Card  </button>
   ...
   <!-- links -->
      ...
      <div class="modal fade" id="myModal2" role="dialog">
         <?php $this->load->view('appayment_report_panel'); ?>      
      </div>
      <!-- Modal - Add Form -->
      ...
      <div class="modal fade" id="myModal3" role="dialog">
         <?php $this->load->view('payable_report_panel'); ?>    
      </div>
      <!-- Modal - Report Form -->
