...
<script type="text/javascript">
    ...
    var sites_ajax  = "<?php echo site_url('stock_adjustment/');?>";
...
-->
   ...
   <div class="btn-group">
   <a class="btn btn-primary" href="<?php echo site_url('stock_adjustment/add'); ?>"> 
   ...
   <!-- links -->
      ...
      <div class="modal fade" id="myModal3" role="dialog">
         <?php $this->load->view('stock_report_panel'); ?>    
      </div>
      <!-- Modal - Report Form -->
