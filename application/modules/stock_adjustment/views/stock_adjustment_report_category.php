...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<center>
	   <div style="border:0px solid green; width:230px;">	
	      <h4> <?php echo isset($company) ? $company : ''; ?> <br> Stock Adjustment - Report Summary </h4>
	   </div>
	</center>
...
<table id="table" border="0">
 <thead>
 <tr>
 <th>No</th> <th>Date</th> <th> Code </th> <th> Type </th> <th> Product </th> <th> Qty </th> <th> Amount </th> <th> Balance </th>
 </tr>
 </thead>
  ...
  <?php 	
      ...
      if ($reports_category)
      {
        ...
        {	
           ...
           <td class=\"strongs\" align=\"center\">".strtoupper($res->type)."</td> 
