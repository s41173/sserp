...
<body onload="closeWindow()">
  ...
  <fieldset class="field"> <legend> Employee Filter </legend>
    <form name="modul_form" class="form-inline" method="post" action="">                        
             <div class="form-group">
<label> NIP </label> <br>
<input type="text" class="form-control" name="tnip" id="tnip" style="width:150px;">
              </div>
              
              <div class="btn-group"> <label>.</label> <br>
               <button type="submit" class="btn btn-primary button_inline"> Filter </button>
               <a href="<?php echo site_url('employee/get_list'); ?>" class="btn btn-success button_inline"> Reset </a>
