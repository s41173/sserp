...
echo form_dropdown('cdivision', $division, isset($default['division']) ? $default['division'] : '', $js); ?>
   ...
   <select name="crtype" id="ctype" class="form-control">
    <option value="0"> Salary / Honor (Static) </option>
    <option value="1"> Salary / Honor (Summary) </option>
    <option value="2"> Salary / Honor (Pivot Table) </option>
    <option value="3"> Pay Sheet </option>
   </select>
        </div>
    </div>
