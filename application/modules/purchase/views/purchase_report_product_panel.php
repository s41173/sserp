...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Purchasing Item - Report </legend>
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>" target="_blank" >
				<table>
            <tr> 
                <td> <label for="tvendor"> Product </label> </td> <td>:</td>
                <td> <input type="text" class="required" readonly name="titem" id="tproduct" size="35" title="Name" /> &nbsp;
