...
enctype="multipart/form-data">
      ...
      <div class="col-md-11 col-sm-9 col-xs-12 form-group">
       ...
       <?php $js = "class='form-control' id='cclassi' tabindex='-1' style='width:100%;' "; 
    ...
    <input type="number" class="form-control has-feedback-left" id="tno" required name="tno" placeholder="No"> 
          </div>
      </div>
      ...
      <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
   <input type="text" class="form-control has-feedback-left" id="talias" name="talias" required placeholder="Alias">
   <span class="fa fa-book form-control-feedback left" aria-hidden="true"></span> 
    ...
    <div class="col-md-11 col-sm-12 col-xs-12 form-group">  
          ...
          <div class="col-md-6 col-sm-12 col-xs-12 form-group">
            <input type="checkbox" name="cactive" id="cactive" value="1" class="flat" /> Active &nbsp;
            <input type="checkbox" name="cbank" id="cbank" value="1" class="flat" /> Bank / Cash 
          </div>
    </div>
