...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Loan Transaction </legend>	
    	
        <form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>">
				<table>
					<tr> 
                
            <td> <label for="tdate"> Date : </label> 
                 <input type="Text" name="tdate" id="d1" title="Born date" size="10" class="form_field" /> 
...
<div id="webadmin2">
	...
	<tbody>
		<tr> 
		   <td align="right"> 
           <?php echo anchor_popup(site_url("loan_trans/add"), 'ADD NEW', $atts2); ?>
           <?php echo anchor_popup(site_url("loan_trans/report"), 'REPORT', $atts1); ?>
		   </td> 
		</tr>
	</tbody>
	</table>
	...
	<fieldset class="field"> <legend> Loan Chart </legend>
