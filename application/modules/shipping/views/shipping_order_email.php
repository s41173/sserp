...
<head>
  ...
  <title> Konfirmasi Pengiriman - #<?php echo isset($so_no) ? $so_no : '' ; ?> </title>
...
<!--  heading awal  -->
    ...
    <tr>
        <td align="center" valign="top" bgcolor="">
           <h2> Konfirmasi Pengiriman #<?php echo isset($so_no) ? $so_no : '' ; ?> </h2> <hr>
        </td>
    </tr>
...
Terima kasih atas kepercayaanmu telah berbelanja di <?php echo isset($p_site_name) ? $p_site_name : '' ; ?>
        </td>
    </tr>
   ...
   <tr>
        <td align="center" valign="top" bgcolor="">
           <p style="text-align:left;"> Berikut adalah penjelasan pengiriman: </p>
        </td>
   </tr>
   ...
   <tr>
        ...
        <p class="content" style="width:150px;"> Waktu Pengiriman </p>
   ...
   <tr>
        <td align="left" valign="top" bgcolor="" style="border-bottom:1px solid #000;"> 
        <p class="content" style="width:150px;"> No Resi </p>
<p class="content" style=""> <?php echo isset($awb) ? $awb : '' ; ?> </p>
        </td>
   </tr>
