...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Checkout Report </legend>
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>" target="_blank" onsubmit="closing();" >
				<table>
					...
					<tr>	
						...
						<td> <label for=""> &nbsp; Type </label></td> <td>:</td> 
						<td>
							 <select name="ctype">
								...
								<option value="nar_refund"> Non Tax AR - Refund </option>
							 </select> &nbsp;
						</td>
