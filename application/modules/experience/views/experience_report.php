    ...
    <script type="text/javascript">
        $(document).ready(function () {
			...
			var rows = $("#table tbody tr");
                ...
                var source = {
                    ...
                    [
						...
						{ name: "Time Work (Years)", type: "string" },
						{ name: "Amount", type: "number" },
						{ name: "Consumption", type: "number" },
						{ name: "Transportation", type: "number" },
						{ name: "Bonus", type: "number" },
						{ name: "Principal", type: "number" },
						{ name: "Principal Helper", type: "number" },
						{ name: "Head Department", type: "number" },
						{ name: "Home Room", type: "number" },
            ...
            $("#jqxgrid").jqxGrid(
            {
				...
				{ text: 'Department', dataField: 'Department', width : 120, cellsalign: 'center' },
				{ text: 'Time Work (Years)', dataField: 'Time Work (Years)', width : 150, cellsalign: 'center' },
				{ text: 'Amount', dataField: 'Amount', width : 150, cellsalign: 'right', cellsformat: 'number', aggregates: ['sum'] },
				{ text: 'Consumption', dataField: 'Consumption', width : 150, cellsalign: 'right', cellsformat: 'number', aggregates: ['sum'] },
				{ text: 'Transportation', dataField: 'Transportation', width : 150, cellsalign: 'right', cellsformat: 'number', aggregates: ['sum'] },
				{ text: 'Bonus', dataField: 'Bonus', cellsalign: 'right', width : 150, cellsformat: 'number', aggregates: ['sum'] },
				{ text: 'Principal', dataField: 'Principal', cellsalign: 'right', width : 150, cellsformat: 'number', aggregates: ['sum'] },
				{ text: 'Principal Helper', dataField: 'Principal Helper', width : 150, cellsalign: 'right', cellsformat: 'number', aggregates: ['sum'] },
				{ text: 'Head Department', dataField: 'Head Department', width : 150, cellsalign: 'right', cellsformat: 'number', aggregates: ['sum'] },
				{ text: 'Home Room', dataField: 'Home Room', cellsalign: 'right', width : 150, cellsformat: 'number', aggregates: ['sum'] },
				{ text: 'Picket', dataField: 'Picket', cellsalign: 'right', width : 150, cellsformat: 'number', aggregates: ['sum'] },
				{ text: 'Insurance', dataField: 'Insurance', cellsalign: 'right', width : 150, cellsformat: 'number', aggregates: ['sum'] }
				
                ]
            });
			
		$('#jqxgrid').jqxGrid({ pagesizeoptions: ['500', '1000', '3000', '5000']}); 
		
		$("#bexport").click(function() {
				
			var type = $("#crtype").val();	
			if (type == 0){ $("#jqxgrid").jqxGrid('exportdata', 'html', 'Experience'); }
			else if (type == 1){ $("#jqxgrid").jqxGrid('exportdata', 'xls', 'Experience'); }
			else if (type == 2){ $("#jqxgrid").jqxGrid('exportdata', 'pdf', 'Experience'); }
			else if (type == 3){ $("#jqxgrid").jqxGrid('exportdata', 'csv', 'Experience'); }
		})	
...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
    ...
    <p style="text-align:center; font-size:14pt; font-weight:bold;"> Employee's Work Experience <br> Premium Report </p>
	...
	<div style="width:100%; border:0px solid brown; margin-top:20px; ">
		...
		<table id="table" border="0" width="100%">
           ...
           <thead>
           <tr>
  	       <th> No </th> <th> Employee </th> <th> Department </th> <th> Time Work (Years) </th> <th> Amount </th> <th> Consumption </th> <th> Transportation </th> <th> Bonus </th> <th> Principal </th>
           <th> Principal Helper </th> <th> Head Department </th> <th> Home Room </th> <th> Picket </th> <th> Insurance </th>
		   </tr>
           </thead>
		  ...
		  <?php 
			  ...
			  function dept($val)
			  {
                  return '';
//				  $emp = new Dept_lib();
//				  if ($val == 0) { $res = ''; } else { $res = $emp->get_name($val); } return $res;
			  }		
			  ...
			  if ($results)
			  {
				...
				{	
				   ...
				   <tr> 
					   ...
					   <td class=\"strongs\">".dept($res->dept)."</td>
					   <td class=\"strongs\" align=\"center\">".$res->time_work."</td>
