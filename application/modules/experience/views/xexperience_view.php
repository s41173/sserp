...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Employee Premium </legend>	
        ...
        <form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>">
            ...
            <td> <label for="tname"> Employee : </label> 
                 <input type="text" name="tname" id="tsearch" size="5" title="Name" />
				 <?php echo anchor_popup(site_url("employees/get_list/"), '[ ... ]', $atts2); ?>
            </td>
            
            <td> <input type="text" id="temployeesearch" name="tvalue" size="45" />  </td>
...
<div id="webadmin2">
	...
	<tbody>
		<tr> 
		   <td align="right"> 
           <?php echo anchor_popup(site_url("experience/add"), 'ADD NEW', $atts2); ?>
