...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Purchasing Return Report </legend>
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>" target="_blank" >
				<table>
					<tr> 
						...
						<td> <input type="text" readonly="readonly" class="required" name="tvendor" id="tcust" size="35" title="Name" /> &nbsp; 
