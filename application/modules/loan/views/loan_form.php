...
<div id="webadmin">
	...
	<form name="modul_form" id="ajaxform" class="myform" method="post" action="<?php echo $form_action; ?>">
		...
		<tr>
        <td> <label for="tnote"> Notes </label> </td>  <td>:</td>
        <td> <input type="text" class="required" name="tnotes" size="35" title="Notes"
      ...
      <td> <input type="text" class="required" name="tamount" id="tamount" size="15" title="Amount" 
