...
<style media="all">
    ...
    <script type="text/javascript">
		...
		$("#bexport").click(function() {
			...
			var type = $("#crtype").val();	
			if (type == 0){ $("#jqxgrid").jqxGrid('exportdata', 'html', 'Loan'); }
			else if (type == 1){ $("#jqxgrid").jqxGrid('exportdata', 'xls', 'Loan'); }
			else if (type == 2){ $("#jqxgrid").jqxGrid('exportdata', 'pdf', 'Loan'); }
			else if (type == 3){ $("#jqxgrid").jqxGrid('exportdata', 'csv', 'Loan'); }
		})	
...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
    ...
    <p style="text-align:center; font-size:14pt; font-weight:bold;"> Employee's Loans Report </p>
	...
	<div style="width:100%; border:0px solid brown; margin-top:20px; ">
		...
		<table id="table" border="0" width="100%">
           ...
           <thead>
           <tr>
  	       <th> No </th> <th> Type </th> <th> Employee </th> <th> Amount </th>
		   </tr>
           </thead>
